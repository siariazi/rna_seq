...
B_names <- c("w.pre","w.40","w.180","w.360","e.pre","e.40","e.180","e.360",
...
plot_norm_subset <- ggplot(plotting_data, aes_string(x = "w.f.720", y="treatment", colour = "large")) + 
  geom_point() + facet_wrap(~variation,nrow = 2) + theme(legend.position="none") + labs(y="") 
